...
<script type="text/javascript">
	$(function() {
		...
		$('#bshoot_detail_Form').form({
			url : '${pageContext.request.contextPath}/api/bshootController/bshoot_detail',
			onSubmit : function() {
			...
			success : function(result) {
				parent.$.messager.progress('close');
				$("#bshoot_detail_result").text(result);
			}
		});
	});
</script>
	...
	<div class="easyui-layout" data-options="fit:true">
		...
		<div data-options="region:'center'">
			<form id="bshoot_detail_Form" action="">
				<table align="center" width="90%" class="tablex">
					...
					<tr>
						...
						<input type="button"
							value="提交" onclick="javascript:$('#bshoot_detail_Form').submit();" /></td>
					</tr>
				</table>
			</form>
			<label>结果：</label>
				<div id="bshoot_detail_result">
				</div>
			<div>
				结果说明：1、json格式<br/>
