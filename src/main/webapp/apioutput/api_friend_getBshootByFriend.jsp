...
<%
String path = request.getContextPath()+"/api/apiFriendController/friend_bshoots";
%>
</head>
<body>
<script type="text/javascript">
	$(function() {
		...
		$('#friend_getBshootByFriend_Form').form({
			url : '<%=path%>',
			onSubmit : function() {
			...
			success : function(result) {
				parent.$.messager.progress('close');
				$("#friend_getBshootByFriend_result").text(result);
			}
		});
	});
</script>
	...
	<div class="easyui-layout" data-options="fit:true">
		...
		<div data-options="region:'center'">
			<form id="friend_getBshootByFriend_Form" action="">
				<table align="center" width="90%" class="tablex">
					...
					<tr>
						...
						<input type="button"
							value="提交" onclick="javascript:$('#friend_getBshootByFriend_Form').submit();" /></td>
					</tr>
				</table>
			</form>
			<label>结果：</label>
				<div id="friend_getBshootByFriend_result">
				</div>
			<div>
				结果说明：1、json格式<br/>
