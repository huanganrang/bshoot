...
<script type="text/javascript">
	$(function() {
		...
		$('#find_abroadBshoot_Form').form({
			url : '${pageContext.request.contextPath}/api/apiFinderController/abroadBshoot',
			onSubmit : function() {
			...
			success : function(result) {
				parent.$.messager.progress('close');
				$("#find_abroadBshoot_result").text(result);
			}
		});
	});
</script>
	...
	<div class="easyui-layout" data-options="fit:true">
		...
		<div data-options="region:'center'">
			<form id="find_abroadBshoot_Form" action="" method="post">
				<table align="center" width="90%" class="tablex">
					<tr>
						<td align="right" style="width: 80px;"><label>url：</label></td>
						<td>${pageContext.request.contextPath}/api/apiFinderController/abroadBshoot</td>
					</tr>
					...
					<tr>
						...
						<input type="button"
							value="提交" onclick="javascript:$('#find_abroadBshoot_Form').submit();" /></td>
					</tr>
				</table>
			</form>
			<label>结果：</label>
				<div id="find_abroadBshoot_result">
				</div>
			<div>
				结果说明：1、json格式<br/>
