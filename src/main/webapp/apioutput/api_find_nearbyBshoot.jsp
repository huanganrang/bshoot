...
<script type="text/javascript">
	$(function() {
		...
		$('#find_nearbyBshoot_Form').form({
			url : '${pageContext.request.contextPath}/api/apiFinderController/nearbyBshoot',
			onSubmit : function() {
			...
			success : function(result) {
				parent.$.messager.progress('close');
				$("#find_nearbyBshoot_result").text(result);
			}
		});
	});
</script>
	...
	<div class="easyui-layout" data-options="fit:true">
		...
		<div data-options="region:'center'">
			<form id="find_nearbyBshoot_Form" action="">
				<table align="center" width="90%" class="tablex">
					<tr>
						<td align="right" style="width: 80px;"><label>url：</label></td>
						<td>${pageContext.request.contextPath}/api/apiFinderController/nearbyBshoot</td>
					</tr>
					...
					<tr>
						...
						<input type="button"
							value="提交" onclick="javascript:$('#find_nearbyBshoot_Form').submit();" /></td>
					</tr>
				</table>
			</form>
			<label>结果：</label>
				<div id="find_nearbyBshoot_result">
				</div>
			<div>
				结果说明：1、json格式<br/>
