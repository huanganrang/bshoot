...
<%
String path = request.getContextPath()+"/api/apiMessageController/message_comment";
%>
</head>
<body>
<script type="text/javascript">
	$(function() {
		...
		$('#message_comment_Form').form({
			...
			success : function(result) {
				parent.$.messager.progress('close');
				$("#message_comment_result").text(result);
			}
		});
	});
</script>
	...
	<div class="easyui-layout" data-options="fit:true">
		...
		<div data-options="region:'center'">
			<form id="message_comment_Form" action="">
				<table align="center" width="90%" class="tablex">
					...
					<tr>
						...
						<input type="button"
							value="提交" onclick="javascript:$('#message_comment_Form').submit();" /></td>
					</tr>
				</table>
			</form>
			<label>结果：</label>
				<div id="message_comment_result">
				</div>
			<div>
				结果说明：1、json格式<br/>
