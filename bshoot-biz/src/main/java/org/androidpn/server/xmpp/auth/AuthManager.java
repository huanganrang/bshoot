...
public class AuthManager {
    ...
    public static String getPassword(String username,String password) throws UserNotFoundException{
    	AndroidUserServiceImpl userService = (AndroidUserServiceImpl)ServiceLocator.getUserService();
    	
    	return userService.getUserByUsername(username, password).getPassword();
    }
    ...
    public static AuthToken authenticate(String username, String password)
        ...
        try {
            if (!password.equals(getPassword(username,password))) {
                throw new UnauthenticatedException();
            }
    ...
    public static AuthToken authenticate(String username, String token,
        ...
        try {
            String password = getPassword(username,null);
