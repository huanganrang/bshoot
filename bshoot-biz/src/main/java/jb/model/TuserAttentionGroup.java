 ...
 */
@Entity
@Table(name = "user_attention_group")
@DynamicInsert(true)
@DynamicUpdate(true)
public class TuserAttentionGroup implements java.io.Serializable {

    private static final long serialVersionUID = 5454155825314635342L;

    //alias
    public static final String TABLE_ALIAS = "UserAttentionGroup";
    ...
    public TuserAttentionGroup(){}
    public TuserAttentionGroup(String id){this.id = id;}
