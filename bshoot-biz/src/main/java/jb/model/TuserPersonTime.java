...
@Entity
@Table(name = "user_person_time")
@DynamicInsert(true)
@DynamicUpdate(true)
public class TuserPersonTime implements java.io.Serializable,IEntity{
	private static final long serialVersionUID = 5454155825314635342L;
	
	//alias
	public static final String TABLE_ALIAS = "UserPersonTime";
	...
	//columns END
		...
		public TuserPersonTime(){
		}
		public TuserPersonTime(String id) {
			this.id = id;
		}
	...
	public boolean equals(Object obj) {
		if(obj instanceof UserPersonTime == false) return false;
		if(this == obj) return true;
		UserPersonTime other = (UserPersonTime)obj;
